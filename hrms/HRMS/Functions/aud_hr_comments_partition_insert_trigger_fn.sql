...
*/
CREATE OR REPLACE FUNCTION aud_hr_comments_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','hr_comments',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_hr_comments_'||v_p_key||' SELECT $1.*';
