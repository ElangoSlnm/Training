...
*/
CREATE OR REPLACE FUNCTION aud_user_skill_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','user_skill',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_user_skill_'||v_p_key||' SELECT $1.*';
