...
*/
CREATE OR REPLACE FUNCTION aud_meal_card_form_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','meal_card_form',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_meal_card_form_'||v_p_key||' SELECT $1.*';
