...
*/
CREATE OR REPLACE FUNCTION aud_etl_sync_to_qb_meta_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','etl_sync_to_qb_meta',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_etl_sync_to_qb_meta_'||v_p_key||' SELECT $1.*';
