...
*/
CREATE OR REPLACE FUNCTION aud_basic_skill_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','basic_skill',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_basic_skill_'||v_p_key||' SELECT $1.*';
