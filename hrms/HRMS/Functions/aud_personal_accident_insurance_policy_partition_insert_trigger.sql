...
*/
CREATE OR REPLACE FUNCTION aud_personal_accident_insurance_policy_partition_insert_trigger()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','personal_accident_insurance_policy',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_personal_accident_insurance_policy_'||v_p_key||' SELECT $1.*';
