...
*/
CREATE OR REPLACE FUNCTION aud_medical_insurance_policy_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','medical_insurance_policy',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_medical_insurance_policy_'||v_p_key||' SELECT $1.*';
