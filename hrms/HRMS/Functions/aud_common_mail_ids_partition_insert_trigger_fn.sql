...
*/
CREATE OR REPLACE FUNCTION aud_common_mail_ids_partition_insert_trigger_fn()
RETURNS trigger AS $$
DECLARE
...
PERFORM create_partition_table_if_not_exists('audit','hrms','common_mail_ids',v_current_date,'hrms');

IF TG_OP='INSERT' THEN 
    v_sql:='INSERT INTO audit.aud_hrms_common_mail_ids_'||v_p_key||' SELECT $1.*';
